function Controller() {
    ...
    function confirm_ans() {
        ...
        if (answer == hint) {
            ...
            upScore.open("POST", "http://nxgninnovations.com/playground/trivia/update_score.php");
            var params = {
                id: demo,
                user1: user_name
            };
            ...
            upScore.onload = function() {
                ...
                p == 1 && quest <= 5 ? loaddata() : quest > 5 ? Alloy.createController("multiplayer").getView().open() : alert("marks not add");
            };
        } else {
    ...
    _.extend($, $.__views);
    var todos = Alloy.Collections.todo, total = 0, att_q = 1, selection = 0, ans1, ans2, ans3, ans4, hint, answer, mul_q, numid1, m = 1;
