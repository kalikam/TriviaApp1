function Controller() {
    ...
    $.__views.sports = Ti.UI.createWindow({
        backgroundColor: "#fff",
        id: "sports"
    });
    $.addTopLevelView($.__views.sports);
    loaddata ? $.__views.sports.addEventListener("load", loaddata) : __defers["$.__views.sports!load!loaddata"] = !0;
    $.__views.addView = Ti.UI.createView({
        id: "addView"
    });
    $.__views.sports.add($.__views.addView);
    ...
    $.__views.sports.add($.__views.ques);
    ...
    $.__views.sports.add($.__views.d);
    $.__views.hint = Ti.UI.createLabel({
        color: "#000",
        id: "hint"
    });
    $.__views.sports.add($.__views.hint);
    ...
    $.__views.sports.add($.__views.next);
    ...
    $.__views.sports.add($.__views.ans);
    ...
    $.__views.sports.add($.__views.confirm);
    ...
    $.__views.sports.add($.__views.cancle);
    exports.destroy = function() {};
    _.extend($, $.__views);
    var todos = Alloy.Collections.todo;
    __defers["$.__views.sports!load!loaddata"] && $.__views.sports.addEventListener("load", loaddata);
