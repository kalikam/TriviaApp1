function Controller() {
    function loaddata() {
        ...
        var s = 3, dataReq = Titanium.Network.createHTTPClient();
    ...
    $.__views.movie.add($.__views.__alloyId7);
    ...
    $.__views.__alloyId7.add($.__views.next);
    ...
    $.__views.__alloyId7.add($.__views.back);
    ...
    $.__views.__alloyId7.add($.__views.skip);
    ...
    allow = 0;
    temp = 0;
    var a1, ans1, ans2, ans3, ans4, hint, hint1, s = 3;
    cur_q = 0;
    next_q = 0;
